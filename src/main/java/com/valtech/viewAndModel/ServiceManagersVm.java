...
public class ServiceManagersVm {
	...
	public ServiceManagersVm(int serviceManagerID, String name, String email, String contact, int branchID) {
		super();
